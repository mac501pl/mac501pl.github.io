...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 0, 25, 25);
    			attr_dev(footer, "class", "bordered svelte-10u45zs");
    ...
    /* src\components\Aside\SidePanel.svelte generated by Svelte v3.38.2 */

    const file$3 = "src\\components\\Aside\\SidePanel.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h1 = element("h1");
    			h1.textContent = "WORK IN PROGRESS";
    			add_location(h1, file$3, 1, 2, 28);
    			attr_dev(aside, "class", "bordered svelte-lybg41");
    ...
    const destinations = ["/", "/about", "/contact", "/portfolio"];
    const labels = ["home", "about", "contact", "portfolio"];
    const labelMap = new Map(lodash_zip(destinations, labels));
    const pathMap = new Map(lodash_zip(labels, destinations));
    const toLabel = (path) => labelMap.get(path);
    const toPath = (label) => pathMap.get(label);

    const pathname = window.location.pathname;
    const initialPath = destinations.includes(pathname) ? pathname : "/";
    const currentCommand = writable(toLabel(initialPath));

    /* src\components\Terminal\Tabs.svelte generated by Svelte v3.38.2 */
    const file$2 = "src\\components\\Terminal\\Tabs.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	function click_handler() {
    		return /*click_handler*/ ctx[1](/*label*/ ctx[2]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(div, "class", "svelte-fwrxa1");
    			add_location(div, file$2, 11, 6, 365);
    			attr_dev(button, "class", "svelte-fwrxa1");
    			toggle_class(button, "current", /*$currentCommand*/ ctx[0] === /*label*/ ctx[2]);
    			add_location(button, file$2, 7, 4, 206);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*$currentCommand, labels*/ 1) {
    				toggle_class(button, "current", /*$currentCommand*/ ctx[0] === /*label*/ ctx[2]);
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(7:2) {#each labels as label}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(nav, "class", "svelte-fwrxa1");
    			add_location(nav, file$2, 5, 0, 168);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$currentCommand, labels, navigate, toPath*/ 1) {
    				each_value = labels;
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let $currentCommand;
    	validate_store(currentCommand, "currentCommand");
    	component_subscribe($$self, currentCommand, $$value => $$invalidate(0, $currentCommand = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	const click_handler = label => navigate(toPath(label), { replace: $currentCommand === label });
    	...
    	return [$currentCommand, click_handler];
    }
    ...
    const yellow = (message) => `\u001b[33m${message}\u001b[0m`;
    const messages = new Map([
        ["contact", `contact ${yellow("http://lol.pl")} contact contact contact contact contact contact contact contact contact contact`],
    ...
    const availableCommandsPrompt = `The list of available commands is the following:\r\n\t${labels
    .map((command) => `"${command}"`)
    .join(" | ")}`;

    class eXTerm extends xterm.Terminal {
        constructor(options) {
            super(options);
            this.prompt = "$ ";
            this.executeCommand = (command = this.command) => {
                this.print(messages.get(command));
                this.clearCommand();
            };
            this.displayErrorMessage = () => {
                this.print(availableCommandsPrompt);
                this.clearCommand();
            };
            this.print = async (message) => {
                const shouldAddExtraLine = this.buffer.active.cursorX > 0;
                const toWrite = `${shouldAddExtraLine ? "\r\n" : ""}${message}\r\n${this.prompt}`;
                for (const c of toWrite) {
                    this.write(c);
                    await new Promise(resolve => setTimeout(resolve, 1));
                }
            };
            this.addCharToCommand = (key) => {
                this._command += key;
                this.write(key);
            };
            this.clearCommand = () => {
            ...
            this.backspace = () => {
                if (this.command) {
                    this._command = this.command.slice(0, -1);
                    this.write("\b \b");
                }
            };
            this._command = "";
    ...
    /* src\components\Terminal\Terminal.svelte generated by Svelte v3.38.2 */
    const file$1 = "src\\components\\Terminal\\Terminal.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 49, 0, 1567);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = action_destroyer(watchResize.call(null, div, /*watchResize_function*/ ctx[2]));
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	let $currentCommand;
    	validate_store(currentCommand, "currentCommand");
    	component_subscribe($$self, currentCommand, $$value => $$invalidate(1, $currentCommand = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("Terminal", slots, []);

    	const term = new eXTerm({
    		...
    		term.onKey(({ key }) => {
    			switch (key.charCodeAt(0)) {
    				case 13:
    					...
    					if (!labels.includes(command)) {
    						term.displayErrorMessage();
    						return;
    					}
    					navigate(toPath(command));
    					return;
    				case 127:
    					term.backspace();
    					return;
    				default:
    					term.addCharToCommand(key);
    					return;
    			}
    		});
    	});
    	...
    	const watchResize_function = () => fitAddon.fit();
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$currentCommand*/ 2) {
    			term.executeCommand($currentCommand);
    		}
    	};

    	return [fitAddon, $currentCommand, watchResize_function];
    }
    ...
    /* src\components\Terminal\TabbedTerminal.svelte generated by Svelte v3.38.2 */
    const file = "src\\components\\Terminal\\TabbedTerminal.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "bordered svelte-aznc4n");
    			add_location(div, file, 4, 0, 108);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("TabbedTerminal", slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<TabbedTerminal> was created with unknown prop '${key}'`);
    	});

    	$$self.$capture_state = () => ({ Nav: Tabs, Terminal });
    	return [];
    }

    class TabbedTerminal extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_default_slot(ctx) {
    	...
    	let footer;
    	let current;
    	tabbedterminal = new TabbedTerminal({ $$inline: true });
    	sidepanel = new SidePanel({ $$inline: true });
    	footer = new Footer({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(tabbedterminal.$$.fragment);
    			t0 = space();
    		...
    		m: function mount(target, anchor) {
    			mount_component(tabbedterminal, target, anchor);
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(tabbedterminal.$$.fragment, local);
    			transition_in(sidepanel.$$.fragment, local);
    			transition_in(footer.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(tabbedterminal.$$.fragment, local);
    			transition_out(sidepanel.$$.fragment, local);
    			transition_out(footer.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(tabbedterminal, detaching);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	globalHistory.listen(({ location: { pathname } }) => currentCommand.set(toLabel(pathname)));
    	const writable_props = [];
